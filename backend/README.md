# Windsor Community Hub – Backend

Flask-based REST API powering the Windsor Community Hub MVP. Provides core endpoints for authentication, housing listings, and community events.
