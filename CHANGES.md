...
|------|-------|----------|------------|
| Helper | `helper@unilife.ca` | `Password123!` | Can verify listings, auto-verified listings |
| Student | `student@unilife.ca` | `Password123!` | Regular user, listings need verification |
...
Built with 💙 for the UniLife Community
